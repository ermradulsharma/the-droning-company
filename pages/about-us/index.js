          ...
          <div className="justify-content-center">
            <div className="MainHeading text-left">
              ...
              <p>If you are a manufacturer and would like our resident drone expert Chris Fravel to conduct a written and video review on your product, please contact him at:{" "}
                <Link href="mailto:cfravel@thedroningcompany.com">cfravel@thedroningcompany.com</Link></p>

              <p>If you have any questions—or if you need advice—please feel free to contact us by e-mail at:{" "} <Link href="mailto:info@thedroningcompany.com">info@thedroningcompany.com</Link></p>
            </div>
          </div>
        </div>
      </div>
