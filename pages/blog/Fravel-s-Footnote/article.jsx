...
import { generateRandomBannerIndex, GetFavBoxData, trancateStr } from "../../../util/utils";
            ...
            {getBlogDetailsPageAdsData_status === "loading" ||
                ...
                <div className="container mt-5">
                    {getBlogDetailsPageAdsData_data && (
                        <AddBan
                            src={
                                getBlogDetailsPageAdsData_data[UNDER_HEADING]?.banner[
                                    topbannerIndex
                            ...
                            <div className="Td_headline">
                                <h2 className="Td_headline_tag">
                                    <span className="Td_headline_content">
                                        <a target="_self">Article</a>
                                    </span>
                                </h2>
                            </div>

                            <div className="row pt-2">
                                {article_data?.favel_box_details?.map((item) => {
                                    return (
