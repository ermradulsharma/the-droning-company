...
const VideoGallery = () => {
  ...
  const handleDeleteVideo = (id) => {
    confirm({
      ...
      .then(async () => {
        ...
        await axios
          .post(`${SERVER_URL}/company-dashboard/reel-video/delete/${id}`, {
            headers: {
              Authorization: `Bearer ${accessToken}`,
            },
          })
  ...
  const markAsMainVideo = async (id) => {
    setFullPageLoading(true);
    await axios
      .post(`${SERVER_URL}/company-dashboard/reel-video/mark-as-main/${id}`, {
        headers: {
          Authorization: `Bearer ${accessToken}`,
        },
      })
                  ...
                  <div className="card-body">
                    ...
                    <Formik
                      ...
                      onSubmit={async (fields, { resetForm }) => {
                        ...
                        axios
                          .post(
                            `${SERVER_URL}/company-dashboard/reel-video/${userId}`,
                            data,
                            {
                              headers: {
                                Authorization: "Bearer " + accessToken,
