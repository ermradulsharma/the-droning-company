                        ...
                        <div className="offset-sm-2 col-sm-8 col-item">
                            <div className="SignForm ThankYouPage">
                                <div className="form-card">
                                    <h1 className="fs-title text-center" style={{ marginBottom: '30px' }}>Thanks for the Payment!</h1>
                                    <h2>Your event has successfully been submitted for approval. Once approved, you will receive email notification and the event will be posted on the calendar.</h2>
                                    <br />
