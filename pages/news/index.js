...
const Blog = (props) => {
  ...
  const getAllBlogPosts = async () => {
    setLoading(true);
    try {
      await fetch(`${SERVER_URL}/blogs?page=${currentPage}`, {
        method: "GET",
      })
        .then((res) => res.json())
        .then((response) => {
            ...
            <div className="row">
              <div className="offset-md-2 col-md-8">
                <div className="BannerText">
                  <div className="BannerTitle">News</div>
                  <p>
                    ...
                    for your travel vlog. We&apos;ve flown plenty, and these are
                    the best drones in our tests.
                  </p>
                </div>
              </div>
            </div>
                    ...
                    return (
                      <>
                        <BlogArticle
                          ...
                          categories={
                            post.hasOwnProperty("blog_categories")
...
export async function getServerSideProps(context) {
  let currentPage = 1;
  return await fetch(`${SERVER_URL}/blogs?page=${currentPage}`, {
    method: "GET",
  })
    .then((res) => res.json())
    .then((response) => {
