...
const Store = () => {
  ...
  const [metaTitle, setMetaTitle] = useState("Consumer Drones");
  const [metaKeyword, setMetaKeyword] = useState("Consumer, Drones");
        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-md-4">
              <StaticBlock
                description={'Autel Robotics EVO II 8K Drone Camera, Portable Folding Aircraft With Remote Controller, Captures Incredibly Smooth 8K Ultra HD Video And 48MP Photos'}
                image={'/images/stores/autel-drone-02.jpg'}
                url={'https://www.autel-store.com/autel-robotics-evo-ii-8k-drone.html?tracking=xyjqm275AmXQyE7RrDjCjU4zwdTzTWXipfBtYs7PzAqWTaZ53PxpIvYHTrxdpgy0'}
                target={'_blank'}
              />
            </div>
            <div className="col-md-4">
