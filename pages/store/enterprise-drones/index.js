...
const Store = () => {
  ...
  const [metaTitle, setMetaTitle] = useState("Enterprise Drones");
  const [metaKeyword, setMetaKeyword] = useState("Enterprise Drones");
      ...
      <div className="drone_stores">
        <div className="container">
          ...
          <ol className="breadcrumb mb-0">
            ...
            <li className="breadcrumb-item active" aria-current="page">Enterprise Drones</li>
          </ol>
          ...
          <div className="row">
            <div className="col-md-4">
              <StaticBlock title={'Draganfly'} image={'/images/stores/draganfly.jpg'} url={'https://draganfly.com/commander-3-xl/'} target={'_blank'} />
            </div>
            <div className="col-md-4">
            </div>
            <div className="col-md-4">
