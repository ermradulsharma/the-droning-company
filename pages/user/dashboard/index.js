...
const Dashboard = () => {
    ...
    return (fullPageLoading ? <div className="row">
        ...
        <div className="row">
            <div className="col-12 text-center justify-content-between">
                <div className="profile-image">
                    <Image className="img-profile rounded-circle med" alt="profile" src={getRecentJob.profile_photo || '/images/no-image.png'} width={150} height={150} />
                </div>
            </div>
        </div>
