                                        ...
                                        <div className="PilotTrackingBox">
                                            <div className="row">
                                                ...
                                                <div className="pilot-info text-primary">
                                                    ...
                                                    <a href="#" role="button" className="SeeMore">View Profile</a>
                                                </div>
                                ...
                                <div className="col-sm-7">
                                    <div className="card">
                                        <div className="card-body">
                                            <a href="" className="btn btn-sm btn-primary shadow-sm float-right"><i className="fas fa-plus fa-sm text-white-50"></i> Send a message</a>
